  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
      ...
      {topPages.length === 0 ? (
        ...
        <div>
          <div className="px-4 sm:px-5 py-2.5 border-b border-gray-50 dark:border-gray-800">
          ...
          {topPages.map((page) => (
            <div
              key={page.path}
              className="px-4 sm:px-5 py-3 border-b border-gray-50 dark:border-gray-800 last:border-0 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors"
            >
