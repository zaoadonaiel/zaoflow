  ...
  return (
    <div className="border border-gray-200 rounded-xl overflow-hidden">
        ...
        {tools.map((tool, i) =>
          tool === null ? (
            ...
            <button
              ...
              onClick={tool.action}
              title={tool.title}
              className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-200 transition-colors text-gray-600 hover:text-gray-900"
            >
      ...
      <div
        ...
        className="article-editor p-5 min-h-[400px] text-gray-800 text-sm outline-none empty:before:content-[attr(data-placeholder)] empty:before:text-gray-400"
        style={{ whiteSpace: 'pre-wrap' }}
      />

      {/* Word / char count bar */}
      <div className="flex items-center justify-end gap-4 px-5 py-2 border-t border-gray-100 bg-gray-50">
        <span className="text-xs text-gray-400">
          <span className={`font-medium ${wordCount > 0 ? 'text-gray-600' : 'text-gray-400'}`}>
