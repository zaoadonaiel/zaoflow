...
import { Globe, Plus, Trash2, RefreshCw, ExternalLink, CheckCircle2, XCircle } from 'lucide-react'
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 border-dashed">
          <div className="flex flex-col items-center gap-4 py-20 text-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Connect your first WordPress site to start publishing</p>
            </div>
            <button
              onClick={() => setShowAdd(true)}
