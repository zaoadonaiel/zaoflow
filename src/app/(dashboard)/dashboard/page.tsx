...
import { Globe, FileText, Calendar, BarChart3, ArrowRight, Plus } from 'lucide-react'
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Overview of your content publishing activity</p>
        </div>
        <Link
          href="/articles/new"
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-brand-600 rounded-2xl p-5 text-white">
            ...
            <p className="text-sm text-brand-100 mb-4">Schedule recurring AI content publishing and let Zaoflo run on its own.</p>
            <Link
              href="/schedules"
